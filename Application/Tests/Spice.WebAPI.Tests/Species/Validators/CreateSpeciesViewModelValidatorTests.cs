...
namespace Spice.WebAPI.Tests.Species.Validators
{
    ...
    internal sealed class CreateSpeciesViewModelValidatorTests
    {
        ...
        [TestCase(1, TestName = "Validator should have error for too short description")]
        ...
        [TestCase(TestName = "Validator should have error for empty LatinName")]
        ...
        [TestCase(null, TestName = "Validator should have error for null latin name")]
        [TestCase(" \n\r\t\r\n\r\n", TestName = "Validator should have error for whitespace latin name")]
        ...
        [TestCase(1, TestName = "Validator should have error for too short latin name")]
        [TestCase(51, TestName = "Validator should have error for too long latin name")]
        ...
        [TestCase("milliliters", TestName = "Validator should not have error for correct latin name")]
