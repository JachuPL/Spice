...
namespace Spice.WebAPI.Tests.Fields.Validators
{
    ...
    {
        private UpdateFieldViewModelValidator _validator;

        [SetUp]
        public void SetUp()
        {
            _validator = new UpdateFieldViewModelValidator();
        }

        [TestCase(" \n\r\t", TestName = "Update Field Validator should have error for whitespace name")]
        [TestCase(null, TestName = "Update Field Validator should have error for null name")]
        public void ValidatorShouldHaveErrorWhenNameIsIncorrect(string name)
        {
            _validator.ShouldHaveValidationErrorFor(x => x.Name, name);
        }

        [TestCase(TestName = "Update Field Validator should have error for empty name")]
        public void ValidatorShouldHaveErrorWhenNameIsEmpty()
        {
            _validator.ShouldHaveValidationErrorFor(x => x.Name, string.Empty);
        }

        [TestCase(1, TestName = "Update Field Validator should have error for too short name")]
        [TestCase(51, TestName = "Update Field Validator should have error for too long name")]
        ...
        [TestCase(TestName = "Update Field Validator should not have error for correct name")]
        ...
        [TestCase(TestName = "Update Field Validator should have error for empty description")]
        ...
        [TestCase(" \n\r\t\r\n\r\n", TestName = "Update Field Validator should have error for whitespace description")]
        ...
        [TestCase(4, TestName = "Update Field Validator should have error for too short description")]
        [TestCase(501, TestName = "Update Field Validator should have error for too long description")]
        ...
        [TestCase(null, TestName = "Update Field Validator should not have error for null description")]
        [TestCase("This is an example description of a field", TestName = "Update Field Validator should not have error for correct description")]
        ...
        [TestCase(-91, TestName = "Update Field Validator should have error for latitude lower than -90")]
        [TestCase(91, TestName = "Update Field Validator should have error for latitude greater than 90")]
        ...
        [TestCase(TestName = "Update Field Validator should not have error for correct latitude")]
        public void ValidatorShouldNotHaveErrorForValidLatitude()
        {
            _validator.ShouldNotHaveValidationErrorFor(x => x.Latitude, 90);
        }

        [TestCase(-181, TestName = "Update Field Validator should have error for longtitude lower than -180")]
        [TestCase(181, TestName = "Update Field Validator should have error for longtitude greater than 180")]
        ...
        [TestCase(TestName = "Update Field Validator should not have error for correct longtitude")]
